...
const CreateForm = ({ onClose }) => {
    ...
    const labelColor = useColorModeValue('teal.900', 'white')
    ...
    return (
        <Box bg={floatFormBg} py={10}>
            {isSubmitting ? <Box align="center" py={60}>
                <Spinner size='xl' thickness='5px' />
            </Box> :
                <form onSubmit={handleSubmit(onSubmit)}>
                    <VStack spacing={2}>
                        <Container maxW={{ base: 'container.md', md: '50%' }}>
                            ...
                            <Box my={3}>
                                <Controller
                                    ...
                                    control={control}
                                    render={({ field }) =>
                                        <Textarea bg={fieldsBg} borderRadius={'md'} id="task-title" {...field} size="sm" placeholder="Task description..." />
                                    } />
                            </Box>
                            ...
                            <Flex
                                ...
                                my={2}>
                                <FormLabel fontWeight={'bold'} color={labelColor} fontSize={'1.2rem'}>Pin to top</FormLabel>
                                <Controller
                                    name="pinned"
                                    control={control}
                                    render={({ field }) =>
